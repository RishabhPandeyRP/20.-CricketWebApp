...
const Header = ({ heading }) => {
    ...
    return (
        <div>
            ...
            <div className='w-full h-[65px] border border-black bg-[#1F41BB] flex justify-between items-center px-4'>
                <div>
                    <img src={rightArr} alt="Back" className="w-[20px] h-[25px]" onClick={() => navigate(-1)} />
                </div>
                <div className='font-medium text-[16px] text-white'>
                    {heading}
                </div>
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-0 left-0 h-full bg-white shadow-lg z-50 flex flex-col  transition-transform duration-300 text-black ${isSidebarOpen ? 'translate-x-0' : '-translate-x-[100%]'
                    }`}
                style={{ width: '300px' }}
            >
                {/* Close Button */}
                ...
                <div className="flex flex-col gap-4 px-0  border-green-500">
                    <div className="border-b border-gray-300 px-3 py-4 bg-[rgb(31,65,187)] flex  items-center gap-5 justify-around">
                        ...
                        <div className='text-white'>
                            <div className="text-lg font-semibold"> {username.split(" ")[0]}</div>
